...
// ファイルにリンクを書き込む
$content = '<!DOCTYPE html><head><style>body {margin: 0;overflow: hidden;}iframe {width: 100vw;height: 100vh;border: none;}</style></head><body><iframe src="' . htmlspecialchars($link) . '"></iframe></body></html>';
